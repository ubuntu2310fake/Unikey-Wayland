...
int main() {
    std::string old_composed = "mẹ"; // m (1 byte) + ẹ (3 bytes)
    std::string new_composed = "me"; // m + e
    ...
    std::cout << "common_bytes: " << common_bytes << std::endl;
    std::cout << "char_backs: " << char_backs << std::endl;
